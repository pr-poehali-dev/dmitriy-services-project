...
const SERVICES = [
  {
    icon: "Hammer",
    title: "Демонтаж",
    desc: "Снос построек, конструкций, перегородок любой сложности. Аккуратно и быстро.",
    price: "от 5 000 ₽",
  },
  {
    icon: "Shovel",
    title: "Скос травы",
    desc: "Покос травы, зарослей, бурьяна на участках любой площади. Ручной и механизированный.",
    price: "от 3 000 ₽",
  },
  {
    icon: "Paintbrush",
    title: "Покраска",
    desc: "Покраска заборов, фасадов, хозпостроек. Качественные материалы, аккуратная работа.",
    price: "от 4 000 ₽",
  },
  {
    icon: "Shovel",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...form, site: "Услуги (без строительства)" }),
      });
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 w-full">
          <div className="max-w-2xl">
            <div className="inline-block bg-[#d4870a] px-3 py-1 mb-6">
              <span className="font-oswald text-white text-xs tracking-[0.2em] uppercase">Бесплатный выезд и оценка</span>
            </div>
            <h1 className="font-oswald text-5xl sm:text-7xl font-bold text-white leading-none mb-6 tracking-tight">
              Демонтаж.<br />
              Скос.<br />
              <span className="text-[#d4870a]">Покраска.</span>
            </h1>
            <p className="text-white/70 text-lg mb-10 font-golos max-w-xl">
              Профессиональный демонтаж, скос травы, покраска и расчистка участков. Работаем по Свердловской области.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { num: "100%", label: "Чистота после работ" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-white/60 font-golos leading-relaxed mb-10">
                Оставьте заявку — мы свяжемся с вами, уточним задачу и назовём точную стоимость. Без скрытых платежей.
              </p>
                  ...
                  <div key={c.text} className="flex items-center gap-3">
                    ...
                    {c.href ? (
                      <a
                        ...
                        className="text-white/80 font-golos hover:text-[#d4870a] transition-colors duration-200"
                      >
                        {c.text}
                      </a>
                    ) : (
            ...
            <div>
              {submitted ? (
                <div className="bg-white/5 border border-white/10 p-10 flex flex-col items-center justify-center text-center min-h-[400px]">
                  ...
                  <p className="text-white/60 font-golos">Мы свяжемся с вами в ближайшее время.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#d4870a] hover:bg-[#b87209] disabled:opacity-60 text-white font-oswald text-sm tracking-[0.15em] uppercase py-4 transition-colors duration-200"
                  >
